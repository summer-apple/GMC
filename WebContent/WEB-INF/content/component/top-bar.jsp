	...
	<ul class="user-info-menu left-links list-inline list-unstyled">
		...
		<li class="dropdown hover-line"><a href="#"
			data-toggle="dropdown"> <i class="fa-envelope-o"></i> <span
				class="badge badge-green">15</span>
		</a>
				...
				<li>
					...
					<ul class="dropdown-menu-list list-unstyled ps-scrollbar">
						...
						<li class="active">
							...
							</span> <span class="line desc small"> This ain’t our first item,
									it is the best of the rest. </span>
						</a>
						</li>
						...
						<li><a href="#"> <span class="line"> Sandra
							...
							</span> <span class="line desc small"> On so attention necessary
									at by provision otherwise existence direction. </span>
						</a></li>
		...
		<li class="dropdown hover-line"><a href="#"
			data-toggle="dropdown"> <i class="fa-bell-o"></i> <span
			...
			<ul class="dropdown-menu notifications">
				...
				<li>
					<ul class="dropdown-menu-list list-unstyled ps-scrollbar">
						...
						<li class="active notification-secondary"><a href="#"> <i
								class="fa-lock"></i> <span class="line"> <strong>Privacy
						...
						<li class="notification-info"><a href="#"> <i
								class="fa-database"></i> <span class="line"> The server
									is status is stable </span> <span class="line small time">
	...
	<ul class="user-info-menu right-links list-inline list-unstyled">
		...
		<li class="dropdown user-profile"><a href="#"
			data-toggle="dropdown"> <img src="assets/images/user-4.png"
				...
				<span> Arlind Nushi <i class="fa-angle-down"></i>
			</span>
		</a>
			...
			<ul class="dropdown-menu user-profile-menu list-unstyled">
				...
				<li><a href="#settings"> <i class="fa-wrench"></i> Settings
				</a></li>
				<li><a href="#profile"> <i class="fa-user"></i> Profile
				</a></li>
		...
		<li><a href="#" data-toggle="chat"> <i class="fa-comments-o"></i>
		</a></li>
