...
<div class="sidebar-menu toggle-others fixed">
	...
	<div class="sidebar-menu-inner">
		...
		<ul id="main-menu" class="main-menu">
			...
			<li class="active opened active"><a href="user/user-profile">
					<i class="linecons-cog"></i> <span class="title">Profile</span>
			</a>
				<ul>
					<li><a href="user/user-profile"> <span class="title">Profile</span>
					</a></li>
					<li><a href="user/user-edit-profile"> <span class="title">Edit
								Profile</span>
					</a></li>
				</ul></li>
			<li><a href="layout-variants.html"> <i
				...
				<ul>
					...
					<li><a
						href="layout-horizontal-sidebar-menu-collapsed-right.html"> <span
							class="title">Both Menus &amp; Collapsed</span>
					</a></li>
					...
					<li><a href="http://www.cssmoban.com"> <span class="title">weidea.net</span>
					</a></li>
				</ul></li>
			<li><a href="ui-panels.html"> <i class="linecons-note"></i>
				...
				<ul>
					...
					<li><a href="ui-tabs-accordions.html"> <span class="title">Tabs
								&amp; Accordions</span>
					</a></li>
					...
					<li><a href="ui-other-elements.html"> <span class="title">Other
								Elements</span>
					</a></li>
				</ul></li>
			...
			<li><a href="tables-basic.html"> <i
				...
				<ul>
					...
					<li><a href="tables-responsive.html"> <span class="title">Responsive
								Table</span>
					</a></li>
					<li><a href="tables-datatables.html"> <span class="title">Data
								Tables</span>
					</a></li>
				</ul></li>
			<li><a href="forms-native.html"> <i class="linecons-params"></i>
				...
				<ul>
					...
					<li><a href="forms-input-masks.html"> <span class="title">Input
								Masks</span>
					</a></li>
					<li><a href="forms-file-upload.html"> <span class="title">File
								Upload</span>
					</a></li>
			...
			<li><a href="extra-gallery.html"> <i class="linecons-beaker"></i>
					<span class="title">Extra</span> <span
				...
				<ul>
					...
					<li><a href="extra-maps-google.html"> <span class="title">Maps</span>
					</a>
						<ul>
					...
					<li><a href="extra-login-light.html"> <span class="title">Login
								Light</span>
					</a></li>
			...
			<li><a href="charts-main.html"> <i class="linecons-globe"></i>
				...
				<ul>
					...
					<li><a href="charts-sparklines.html"> <span class="title">Sparklines</span>
					</a></li>
					...
					<li><a href="charts-bar-gauges.html"> <span class="title">Bar
								Gauges</span>
					</a></li>
				</ul></li>
			<li><a href="#"> <i class="linecons-cloud"></i> <span
				...
				<ul>
					<li><a href="#"> <i class="entypo-flow-line"></i> <span
						...
						<ul>
							<li><a href="#"> <i class="entypo-flow-parallel"></i> <span
									class="title">Menu Level 2.1</span>
							</a></li>
							<li><a href="#"> <i class="entypo-flow-parallel"></i> <span
									class="title">Menu Level 2.2</span>
							</a>
								<ul>
									<li><a href="#"> <i class="entypo-flow-cascade"></i> <span
											class="title">Menu Level 3.1</span>
									</a></li>
									<li><a href="#"> <i class="entypo-flow-cascade"></i> <span
											class="title">Menu Level 3.2</span>
									</a>
										<ul>
							...
							<li><a href="#"> <i class="entypo-flow-parallel"></i> <span
									class="title">Menu Level 2.3</span>
							</a></li>
						</ul></li>
					<li><a href="#"> <i class="entypo-flow-line"></i> <span
