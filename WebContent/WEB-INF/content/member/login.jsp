			...
			<div class="col-sm-6">
				...
				<form method="post" role="form" id="login" class="login-form fade-in-effect" action="login">
					...
					<div class="login-header">
						...
						<c:if test="${!empty message}"><p><span class="text-danger">${message}</span></p></c:if>
					...
					<div class="form-group">
						...
						<input type="password" class="form-control input-dark" name="user_pass" id="passwd" autocomplete="off" />
					</div>
					
					<c:if test="${wrongPassCount>3}">
					<div class="form-group">
						<label class="control-label" for="verify-code">Virfy Code</label>
						<input type="text" class="form-control input-dark" name="verify_code" id="verify-code" autocomplete="off" />
						<a href="#" onclick="changeImg()"><img id="verify-img" src="verify-code" style="width: 100px; height: 38px;  position: absolute;  top: 1px; right: 1px;"></a>
					</div>
					</c:if>
