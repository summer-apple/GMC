		...
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<form method="post" role="form" id="login"
					class="login-form fade-in-effect" action="register">

					<div class="login-header">
						<a href="../index/index" class="logo"> <img
							src="../assets/images/logo@2x.png" alt="" width="80" /> <span>register</span>
						</a>
					...
					<div class="form-group">
						<label class="control-label" for="user-pass">Password</label> <input
							type="password" class="form-control input-dark" name="user_pass"
							id="user-pass" autocomplete="off" />
					</div>

					<div class="form-group">
						<label class="control-label" for="pass-conf">Confirm</label> <input
							type="password" class="form-control input-dark" name="pass_conf"
							id="pass-conf" autocomplete="off" />
					</div>
