	...
	<div class="login-container">
		...
		<div class="row">
			...
			<div class="col-sm-7">
				...
				<form role="form" id="lockscreen"
					class="lockcreen-form fade-in-effect" method="post" action="login">

					<div class="user-thumb">
						<a href="#"> <img src="../assets/images/user-5.png"
					...
					<div class="form-group">
						...
						<div class="input-group">
							<input type="password" class="form-control input-dark"
								name="passwd" id="passwd" placeholder="Password" /> <span
